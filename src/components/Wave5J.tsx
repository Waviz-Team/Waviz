...
function Wave1({
  ...
  let defaults = [
    { domain: ['time', 400], coord: ['polar'], color: ['#eb1b00ff'] },
    { domain: ['time', 350], coord: ['polar'], color: ['#eb4300ff'] },
    { domain: ['time', 300], coord: ['polar'], color: ['#ff6715ff'] },
    { domain: ['time', 250], coord: ['polar'], color: ['#ff9320ff'] },
    { domain: ['time', 200], coord: ['polar'], color: ['#ffb836ff'] },
    { domain: ['time', 150], coord: ['polar'], color: ['#ffca68ff'] },
    { domain: ['time', 100], coord: ['polar'], color: ['#ffdd9dff'] },
    { domain: ['time', 50], coord: ['polar'], color: ['#ffeeceff'] },
  ];
