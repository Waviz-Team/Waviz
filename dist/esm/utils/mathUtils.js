...
export function polarInter(input, blendCount) {
...
export function makePeriodic(input) {
...
//* Window Functions
export function hanWindow(input) {
...
export function hammingWindow(input) {
...
export function exponentialWindow(input, a = 0.01) {
...
export function blackmanHarrisWindow(input) {
